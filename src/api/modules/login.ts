...
import qs from "qs"
import { http, request, CommonBaseURL } from "@/api"
...
// 	return http.post<Login.ResLogin>(SsoBaseURL + `/connect/token`, qs.stringify(params))
// }
// * 用户注册
// export const registerApi = (data: any) => {
// 	return request({
// 		url: SsoBaseURL + "/api/Account/RegisterWithoutUsername",
// 		method: "post",
// 		data
// 	})
// }
...
export const getAuthMenuListApi = () => {
	// return http.get<Menu.MenuOptions[]>(UumsBaseURL + `/api/Menus/GetList`, {}, { headers: { noLoading: true } })

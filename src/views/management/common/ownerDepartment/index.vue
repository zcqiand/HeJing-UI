<template>
	<div class="app-container">
		...
		<edit v-if="dialogVisible" ref="editRef" :ownerId="ownerId" @success="handleSaveSuccess"></edit>
	</div>
</template>
...
@/api/management/common/ownerEntity@/api/management/common/ownerDepartment
